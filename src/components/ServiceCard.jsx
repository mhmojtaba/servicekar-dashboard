...
const ServiceCard = ({ icon, title, description, delay = 0 }) => {
  return (
    <Card
      className="group hover:shadow-xl transition-all duration-500 hover:-translate-y-2 animate-fade-in border-0 shadow-lg bg-gradient-to-br from-white to-gray-50"
